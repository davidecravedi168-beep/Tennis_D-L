...
shell=replaceOnce(shell,"const VERSION='TEP_FULL_PREMIUM_UI_V3_5';","const VERSION='TEP_FULL_PREMIUM_UI_V3_7';",'V3.5 version marker');
shell=replaceOnce(shell,"if(window.__TEP_FULL_PREMIUM_UI_V35)return;\nwindow.__TEP_FULL_PREMIUM_UI_V35=true;","if(window.__TEP_FULL_PREMIUM_UI_V37)return;\nwindow.__TEP_FULL_PREMIUM_UI_V37=true;",'V3.5 runtime guard');
...
index=replaceOnce(index,'<link rel="manifest" href="./manifest.webmanifest">','<link rel="manifest" href="./manifest.webmanifest?v=20260911-v37-nav-direct">','manifest cache bust');
index=replaceOnce(index,'premium-shell-v1.js?v=20260911-v35-runtime-fix','premium-shell-v1.js?v=20260911-v37-nav-direct','premium shell cache bust');
manifest=replaceOnce(manifest,'"start_url": "./?v=20260911-v35-runtime-fix"','"start_url": "./?v=20260911-v37-nav-direct"','manifest start_url cache bust');

if(!shell.includes('TEP_FULL_PREMIUM_UI_V3_7')) throw new Error('V3.7 marker missing after patch');
if(!shell.includes('TEP_IOS_NAV_BIND_V37')) throw new Error('V3.7 direct nav binder missing');
...
console.log('IOS_NAV_V37_PATCH=PASS');
