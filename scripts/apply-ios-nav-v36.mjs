...
index=replaceOnce(index,'<link rel="manifest" href="./manifest.webmanifest">','<link rel="manifest" href="./manifest.webmanifest?v=20260911-v38-nav-runtime">','manifest cache bust');
index=replaceOnce(index,'premium-shell-v1.js?v=20260911-v35-runtime-fix','premium-shell-v1.js?v=20260911-v38-nav-runtime','premium shell cache bust');
manifest=replaceOnce(manifest,'"start_url": "./?v=20260911-v35-runtime-fix"','"start_url": "./?v=20260911-v38-nav-runtime"','manifest start_url cache bust');
