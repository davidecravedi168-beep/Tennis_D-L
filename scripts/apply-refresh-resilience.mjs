...
const photoTag='<script src="player-photos.js?v=20260911-v34"></script>';
const premiumTag='<script src="premium-shell-v1.js?v=20260911-v34-instant-portraits"></script>';
...
if(!s.includes(photoTag)||!s.includes(premiumTag))throw new Error('V3.4 shell wiring missing');
...
if(s!==original){fs.writeFileSync(file,s);console.log('Tennis refresh resilience + premium V3.4 portrait catalog wiring normalized')}else console.log('Tennis premium V3.4 runtime wiring already normalized');
