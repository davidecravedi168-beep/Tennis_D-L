...
const premiumTag='<script src="premium-shell-v1.js?v=20260912-v39-nav-fix"></script>';
...
if(!s.includes(photoTag)||!s.includes(premiumTag))throw new Error('V3.8 shell wiring missing');
...
if(s!==original){fs.writeFileSync(file,s);console.log('Tennis refresh resilience + premium V3.8 runtime wiring normalized')}else console.log('Tennis premium V3.8 runtime wiring already normalized');
